...
class Ui_generalSettingsWindow(object):
    def setupUi(self, generalSettingsWindow):
        ...
        self.saveButton.setGeometry(QtCore.QRect(710, 600, 151, 41))
    ...
    def retranslateUi(self, generalSettingsWindow):
        ...
        self.saveButton.setText(_translate("generalSettingsWindow", "Save"))
    ...
    def saveData(self):
        ...
        f = open('%s/%s'%(Filer.SETTINGS_FOLDER, Filer.SETTINGS_FILE_NAME),'w')
